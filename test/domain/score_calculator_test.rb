...
class ScoreCalculatorTest < ActiveSupport::TestCase
  ...
  test '#get_yaku_list：場風 東' do
    # p234567 s23455 z111 ※z1:東
    hands = {
      'm' => [ 0, 0, 0, 0, 0, 0, 0, 0, 0 ],
      'p' => [ 0, 1, 1, 1, 1, 1, 1, 0, 0 ],
      's' => [ 0, 1, 1, 1, 2, 0, 0, 0, 0 ],
  ...
  test '#get_yaku_list：自風 南' do
    # p234567 s23455 z222 ※z2:南
    hands = {
      'm' => [ 0, 0, 0, 0, 0, 0, 0, 0, 0 ],
      'p' => [ 0, 1, 1, 1, 1, 1, 1, 0, 0 ],
      's' => [ 0, 1, 1, 1, 2, 0, 0, 0, 0 ],
  ...
  test '#get_yaku_list：翻牌 白' do
    # p234567 s23455 z444 ※z4:白
    hands = {
      'm' => [ 0, 0, 0, 0, 0, 0, 0, 0, 0 ],
      'p' => [ 0, 1, 1, 1, 1, 1, 1, 0, 0 ],
      's' => [ 0, 1, 1, 1, 2, 0, 0, 0, 0 ],
  ...
  test '#get_yaku_list：平和' do
    # m123 p123456 s789 z11　※z1:南
    hands = {
      'm' => [ 1, 1, 1, 0, 0, 0, 0, 0, 0 ],
      'p' => [ 1, 1, 1, 1, 1, 1, 0, 0, 0 ],
      's' => [ 0, 0, 0, 0, 0, 0, 1, 1, 1 ],
  ...
  test '#get_yaku_list：三色同順(面前 han = 2)' do
    # m123 p123 s123567 z22
    hands = {
      'm' => [ 1, 1, 1, 0, 0, 0, 0, 0, 0 ],
      'p' => [ 1, 1, 1, 0, 0, 0, 0, 0, 0 ],
      's' => [ 1, 1, 1, 0, 1, 1, 1, 0, 0 ],
  ...
  test '#get_yaku_list：三色同順(鳴き han = 1)' do
    # m123 p123 s123567 z22
    hands = {
      'm' => [ 1, 1, 1, 0, 0, 0, 0, 0, 0 ],
      'p' => [ 0, 0, 0, 0, 0, 0, 0, 0, 0 ],
  ...
  test '#get_yaku_list：一気通貫(面前 han = 2)' do
    # m123456789 p234 z22
    hands = {
      'm' => [ 1, 1, 1, 1, 1, 1, 1, 1, 1 ],
      'p' => [ 0, 1, 1, 1, 0, 0, 0, 0, 0 ],
  ...
  test '#get_yaku_list：一気通貫(鳴き han =1)' do
    # m123456789 p234 z22
    hands = {
      'm' => [ 1, 1, 1, 0, 0, 0, 1, 1, 1 ],
      'p' => [ 0, 1, 1, 1, 0, 0, 0, 0, 0 ],
  ...
  test '#get_yaku_list：混全帯幺九(面前 han = 2)' do
    # m123789 p111999 z22
    hands = {
      'm' => [ 1, 1, 1, 0, 0, 0, 1, 1, 1 ],
      'p' => [ 3, 0, 0, 0, 0, 0, 0, 0, 3 ],
  ...
  test '#get_yaku_list：混全帯幺九(鳴き han =1)' do
    # m123789 p111999 z22
    hands = {
      'm' => [ 1, 1, 1, 0, 0, 0, 0, 0, 0 ],
      'p' => [ 3, 0, 0, 0, 0, 0, 0, 0, 3 ],
  ...
  test '#get_yaku_list：対々和' do
    # m111333 p111 p222 z22
    hands = {
      'm' => [ 3, 0, 3, 0, 0, 0, 0, 0, 0 ],
      'p' => [ 3, 0, 0, 0, 0, 0, 0, 0, 0 ],
      's' => zero9.dup,
  ...
  test '#get_yaku_list：三槓子' do
    # m1111 2222 3333 p123 z22
    hands = {
      'm' => [ 0, 0, 0, 0, 0, 0, 0, 0, 0 ],
      'p' => [ 1, 1, 1, 0, 0, 0, 0, 0, 0 ],
      's' => zero9.dup,
  ...
  test '#get_yaku_list：三色同刻' do
    # m111 p111 s111 p234 z22
    hands = {
      'm' => [ 0, 0, 0, 0, 0, 0, 0, 0, 0 ],
      'p' => [ 0, 1, 1, 1, 0, 0, 0, 0, 0 ],
      's' => zero9.dup,
  ...
  test '#get_yaku_list：混老頭 七対子' do
    # m1199 p1199 s1199 z11
    hands = {
      'm' => [ 2, 0, 0, 0, 0, 0, 0, 0, 2 ],
      'p' => [ 2, 0, 0, 0, 0, 0, 0, 0, 2 ],
      's' => [ 2, 0, 0, 0, 0, 0, 0, 0, 2 ],
  ...
  test '#get_yaku_list：清老頭' do
    # m111999 p111 p999 s11
    hands = {
      'm' => [ 3, 0, 0, 0, 0, 0, 0, 0, 3 ],
      'p' => [ 0, 0, 0, 0, 0, 0, 0, 0, 3 ],
      's' => [ 2, 0, 0, 0, 0, 0, 0, 0, 0 ],
